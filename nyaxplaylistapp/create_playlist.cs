...
namespace nyaxplaylistapp
{
    ...
    public partial class create_playlist : Form
    {
        ...
        // Timers namespace rather than Threading
        System.Timers.Timer worker_timer = new System.Timers.Timer(); // Doesn't require any args
...
UnhandledExceptionEventHandler(UnhandledException);
        ...
        void log_file_info(string strfilename, string strfilesize, string strpathfolder)
        {
            ...
            _sb.AppendLine("strfilesize [ " + formatmediasize(strfilesize) + " ]");
        ...
        private void create_playlist_Load(object sender, EventArgs e)
        {
            ...
            worker_timer.Interval = 1000;
            worker_timer.Elapsed += worker_timer_Elapsed; // Uses an event instead of a delegate
            worker_timer.Start(); // Start the timer
        ...
        void running_timer_Elapsed(object sender, EventArgs e)
        {
        ...
        void worker_timer_Elapsed(object sender, EventArgs e)
        {
            //update counta variable
            _global_time_lapsed_counta++;

            lbltimelapsed.Text = secondstominutesandhours(double.Parse(_global_time_lapsed_counta.ToString()));
        }
        ...
        string formatmediasize(string _mediasize)
        {
            var _fl_size = 0d;
            var _str_size = "";
            var _sizeinbytes = int.Parse(_mediasize);

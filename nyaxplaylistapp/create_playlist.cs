        ...
        void get_files_in_folder(string _selected_media_type)
        {
            ...
            switch (_selected_media_type)
            {
                ...
                case DBContract.series:
                    ...
                    var FileSearchRes = Directory.GetFiles(_str_path, "*.mp4*", SearchOption.AllDirectories);
                    FileSearchRes = Directory.GetFiles(_str_path, "*.mp4*", SearchOption.AllDirectories);
                    break;
                case DBContract.audio:
                    _str_path = _str_path + DBContract.audio;
                    FileSearchRes = Directory.GetFiles(_str_path, "*.mp3*", SearchOption.AllDirectories);
                    break;
            }
